<%@ Page Title="הוסף עובד" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="AddWorker.aspx.cs" Inherits="AddWorker" %>
    ...
    <script type="text/javascript">
        function Check() {
            ...
            if (document.Insert_Worker.worker_Phone.value != "") {
                ...
                if (document.Insert_Worker.worker_Phone.value.length !=7) {
                    document.Insert_Worker.worker_Phone.focus();
