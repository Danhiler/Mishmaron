<%@ Page Title="צור קשר" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Contact_logged.aspx.cs" Inherits="Contact_logged" %>
...
<td>
    שם מלא:</td>
<td>
<input type ="text" name="Full_Name" value ="<%=Session["wname"] %>"/>
</td></tr>
<tr>
<td>
אימייל:
...
<td>
<input type ="text" name="E_Mail" value="<%=email%>" />
</td></tr>
<tr>
<td>
    הפנייה:</td>
...
<td colspan="2" style="text-align: center">
    <input id="Submit1" type="submit" name="log" value="שלח" /></td></tr>
</table>
</form>
</asp:Content>
