<%@ Page Title="שליחת התרעת חוסרים" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Send_Emergency.aspx.cs" Inherits="Send_Emergency" %>
...
<table>
<tr><td>
<h2>דו"ח פרסום הודעת מילוי חוסרים</h2>
</td></tr>
<tr><td align="center">
להלן מופיעות תוצאות הפרסום של הודעת מילוי החוסרים
    :</td></tr>
<tr><td>
<%Print_Resualt(); %>
